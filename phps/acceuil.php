...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex" role="search" method="GET" action="search.php">
          <input class="form-control me-2" type="search" placeholder="Search by event type" aria-label="Search" name="event_type">
  ...
  <div class="cards">
    ...
    if (isset($_GET['event_type']) && !empty($_GET['event_type'])) {
      ...
      $sql = "SELECT id, photo, name, type FROM Events WHERE type='$event_type'";
    } else {
